...
def implicit_conv2d(
    ...
    for pipe in cutlass.range_constexpr(S_PIPES - 1):
        ...
        cute.copy(g2s_thr_copy_B, tBgB[None, None, None, tile_idx], tBsB[None, None, None, pipe])
    ...
    for k_iter in range(K_ITERS):
        ...
        if k_iter < TILES:
            ...
            cute.copy(g2s_tiled_copy_B, tBgB[None, None, None, tile_idx], tBsB[None, None, None, pipe_w])
        cute.arch.cp_async_commit_group()
...
def entry(
    ...
    tiled_mma = cute.make_tiled_mma(
        ...
        # permutation_mnk=(
        #     # cute.make_layout((8, 2, 4), stride=(2, 1, 16)),
        #     64,
        #     # cute.make_layout((2, 4, 4, 2), stride=(1, 8, 2, 32)),
        #     64,
        #     16
        # )
    )
